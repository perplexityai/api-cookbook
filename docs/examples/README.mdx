...
<Warning>
**This directory is frozen.** These examples were written for the Sonar API, which shuts down on 2026-09-27, and the code will stop working on that date. Current, tested Agent API examples live in the [cookbook on docs.perplexity.ai](https://docs.perplexity.ai/docs/cookbook). This repository now accepts community showcase projects only; see [CONTRIBUTING.md](https://github.com/perplexityai/api-cookbook/blob/main/CONTRIBUTING.md).
</Warning>
