...
In-depth tutorials for advanced implementations and integrations with other tools, including
[AG2 (AutoGen)](/cookbook/articles/ag2-integration/README) and
[OpenAI Agents](/cookbook/articles/openai-agents-integration/README).
