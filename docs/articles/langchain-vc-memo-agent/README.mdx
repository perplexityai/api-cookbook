...
The harness is a small package rather than a single file, so it lives in the [api-cookbook repository](https://github.com/perplexityai/api-cookbook/tree/main/docs/articles/langchain-vc-memo-agent):
...
Inside [`docs/articles/langchain-vc-memo-agent/`](https://github.com/perplexityai/api-cookbook/tree/main/docs/articles/langchain-vc-memo-agent) in api-cookbook:
