...
A collection of practical guides, runnable examples, and integration patterns for building with [**Perplexity's API Platform**](https://docs.perplexity.ai/) — covering the Agent API, Search API, and Embeddings API.
...
Connect Perplexity with external frameworks like LangGraph and LangSmith.
</Card>
</CardGroup>
